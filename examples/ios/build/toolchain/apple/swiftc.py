...
def main(args):
  ...
  parser.add_argument(
      '--object-dir', '-o', help='path to the generated object files directory')
  parser.add_argument(
      '--module-path', '-m', help='path to the generated module file')
  parser.add_argument(
      '--header-path', '-h', help='path to the generated header file')
  parser.add_argument(
      '--bridge-header', '-b', help='path to the Objective-C bridge header')
  parser.add_argument('--depfile', '-d', help='path to the generated depfile')
  parser.add_argument(
      '--depfile-filter', action='append', help='limit depfile to those files')
  parser.add_argument(
      '--target',
      action='store',
