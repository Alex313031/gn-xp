...
//
// The link_tag is set, it will be used for markdown output links. If
// unspecified one will be autogenerated. In non-markdown mode, this parameter
// will be ignored.
//
...
//
// The tag will be used as a link target for the first header. If empty, one
// will be generated.
