...
bool FilesystemStringsEqual(const base::FilePath::StringType& a,
  ...
  return ::CompareString(LOCALE_USER_DEFAULT, LINGUISTIC_IGNORECASE, reinterpret_cast<LPCWSTR>(a.c_str()),
                         -1, reinterpret_cast<LPCWSTR>(b.c_str()), -1) == CSTR_EQUAL;
#else
...
bool WriteFile(const base::FilePath& file_path,
  ...
  base::win::ScopedHandle file(::CreateFile(reinterpret_cast<LPCWSTR>(file_path.value().c_str()),
