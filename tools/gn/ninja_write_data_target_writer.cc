...
NinjaWriteDataTargetWriter::NinjaWriteDataTargetWriter(
    const Target* target,
    std::ostream& out)
    : NinjaTargetWriter(target, out) {}

NinjaWriteDataTargetWriter::~NinjaWriteDataTargetWriter() = default;

void NinjaWriteDataTargetWriter::Run() {
  // A write_data target should just generate a stamp file with dependencies
