...
TEST_F(NinjaCBinaryTargetWriterTest, SourceSet) {
  ...
  target.source_types_used().Set(SOURCE_CPP);
  target.source_types_used().Set(SOURCE_O);
...
TEST_F(NinjaCBinaryTargetWriterTest, CompleteStaticLibrary) {
  ...
  baz.source_types_used().Set(SOURCE_CPP);
...
TEST_F(NinjaCBinaryTargetWriterTest, NoHardDepsToNoPublicHeaderTarget) {
  ...
  gen_obj.source_types_used().Set(SOURCE_CPP);
  ...
  gen_lib.source_types_used().Set(SOURCE_H);
  ...
  executable.source_types_used().Set(SOURCE_CPP);
...
TEST_F(NinjaCBinaryTargetWriterTest, SourceSetDataDeps) {
  ...
  inter.source_types_used().Set(SOURCE_CPP);
  ...
  exe.source_types_used().Set(SOURCE_CPP);
...
TEST_F(NinjaCBinaryTargetWriterTest, SharedLibraryModuleDefinitionFile) {
  ...
  shared_lib.source_types_used().Set(SOURCE_CPP);
  shared_lib.source_types_used().Set(SOURCE_DEF);
...
TEST_F(NinjaCBinaryTargetWriterTest, LoadableModule) {
  ...
  loadable_module.source_types_used().Set(SOURCE_CPP);
...
TEST_F(NinjaCBinaryTargetWriterTest, WinPrecompiledHeaders) {
  ...
  // This target doesn't specify precompiled headers.
  {
    ...
    no_pch_target.source_types_used().Set(SOURCE_CPP);
    no_pch_target.source_types_used().Set(SOURCE_C);
  ...
  // This target specifies PCH.
  {
    ...
    pch_target.source_types_used().Set(SOURCE_CPP);
    pch_target.source_types_used().Set(SOURCE_C);
