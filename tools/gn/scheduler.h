...
class Scheduler {
 public:
  ...
  // Schedules a file to be written due to a write_data type.
  void AddWriteDataTarget(const Target* entry);
  std::vector<const Target*> GetWriteDataTargets() const;
  bool IsFileGeneratedByWriteData(const OutputFile& file) const;
