...
extern const char kNodeChild[];
extern const char kNodeType[];
extern const char kNodeValue[];
extern const char kBeforeComment[];
extern const char kSuffixComment[];
extern const char kAfterComment[];
