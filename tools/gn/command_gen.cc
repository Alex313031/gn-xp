...
bool RunIdeWriter(const std::string& ide,
  ...
  if (ide == kSwitchIdeValueEclipse) {
    ...
    XcodeWriter::WorkspaceSettings workspace_settings;
    if (command_line->HasSwitch(kSwitchUseOriginalBuilder)) {
      workspace_settings.emplace_back("BuildSystemType", "Original");
    }
