...
// NOTE: Using {} instead of '= default' is necessary to avoid a Clang compiler
// warning that looks like;
//
//    error: defaulting this default constructor would delete it after its \
//        first declaration
//    Value::Value() = default;
//           ^
//    note: default constructor of 'Value' is implicitly deleted because \
//        variant field 'string_value_' has a non-trivial default constructor
