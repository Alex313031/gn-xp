...
const char kWalkKeys_Help[] =
  ...
  If no walk_keys are specified for a write_data target (i.e. "[]"), the
  walk will touch all deps and data_deps of the specified target recursively.

  See "gn help write_data".
)";

const char kWriteDataOutput[] = "write_data_output";
const char kWriteDataOutput_HelpShort[] =
    "write_data_output: Path for writing the given data.";
const char kWriteDataOutput_Help[] =
    R"(write_data_output: Path for writing the given data.
  
  Must be within the output directory. See "gn help write_data".
)";

const char kWriteDataValue[] = "data";
const char kWriteDataValue_HelpShort[] =
    "data: Data to write to file.";
const char kWriteDataValue_Help[] =
    R"(data: Data to write to file.
  
  See "gn help write_file".
)";

const char kWriteOutputConversion[] = "write_output_conversion";
const char kWriteOutputConversion_HelpShort[] =
    "write_output_conversion: Controls how the output is written.";
...
const VariableInfoMap& GetTargetVariables() {
  ...
  if (info_map.empty()) {
    ...
    INSERT_VARIABLE(WriteDataOutput)
    INSERT_VARIABLE(WriteDataValue)
