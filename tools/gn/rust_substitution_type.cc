...
const Substitution kRustSubstitutionCrateName = {"{{crate_name}}", "crate_name"};
const Substitution kRustSubstitutionCrateType = {"{{crate_type}}", "crate_type"};
...
bool IsValidkRustSubstitution(const Substitution* type) {
  return IsValidToolSubstitution(type) || IsValidSourceSubstitution(type) ||
         ...
         type == &kRustSubstitutionEdition || type == &kRustSubstitutionExterns ||
         type == &kRustSubstitutionOutputExtension ||
         type == &kRustSubstitutionOutputPrefix ||
         type == &kRustSubstitutionRustDeps ||
         type == &kRustSubstitutionRustEnv || type == &kRustSubstitutionRustFlags;
}