...
TEST_F(NinjaRustBinaryTargetWriterTest, RustExecutable) {
...

  {
    ...
    const char expected[] =
        ...
        "target_output_name = bar\n"
        "\n"
        "build ./foo_bar: rustc ../../foo/main.rs | ../../foo/input3.rs "
...
TEST_F(NinjaRustBinaryTargetWriterTest, RlibDeps) {
...

  {
    ...
    const char expected[] =
        ...
        "\n"
        "build obj/bar/libmylib.rlib: rlib ../../bar/lib.rs | "
...

  {
    ...
    const char expected[] =
        ...
        "target_output_name = bar\n"
        "\n"
        "build ./foo_bar: rustc ../../foo/main.rs | ../../foo/source.rs "
...
TEST_F(NinjaRustBinaryTargetWriterTest, RustOutputExtensionAndDir) {
...

  {
    ...
    const char expected[] =
        ...
        "target_output_name = bar\n"
        "\n"
        "build ./foo_bar.exe: rustc ../../foo/main.rs | ../../foo/input3.rs "
        "../../foo/main.rs ../../foo/input1.rs ../../foo/input2.rs || "
        "obj/foo/sources.stamp\n"
        "  rustdeps =\n";
    std::string out_str = out.str();
...
TEST_F(NinjaRustBinaryTargetWriterTest, LibsAndLibDirs) {
...

  {
    ...
    const char expected[] =
        ...
        "target_output_name = bar\n"
        "\n"
        "build ./foo_bar: rustc ../../foo/main.rs | ../../foo/input.rs "
        "../../foo/main.rs\n"
...
TEST_F(NinjaRustBinaryTargetWriterTest, ProcMacro) {
...

  {
    ...
    const char expected[] =
        ...
        "\n"
        "build obj/bar/libmymacro.so: proc_macro ../../bar/lib.rs | "
        "../../bar/mylib.rs ../../bar/lib.rs\n"
        "  rustdeps =\n";
    std::string out_str = out.str();
    EXPECT_EQ(expected, out_str) << out_str;
