...
void TestWithScope::SetupToolchain(Toolchain* toolchain) {
  ...
  // OBJC
  std::unique_ptr<Tool> objc_tool = std::make_unique<Tool>(Tool::TYPE_OBJC);
  SetCommandForTool(
  ...
  // OBJC
  std::unique_ptr<Tool> objcxx_tool = std::make_unique<Tool>(Tool::TYPE_OBJCXX);
  SetCommandForTool(
  ...
  // ALINK
  std::unique_ptr<Tool> alink_tool = std::make_unique<Tool>(Tool::TYPE_ALINK);
  ...
  std::unique_ptr<Tool> solink_module_tool =
      std::make_unique<Tool>(Tool::TYPE_SOLINK_MODULE);
  SetCommandForTool(
  ...
  // LINK
  std::unique_ptr<Tool> link_tool = std::make_unique<Tool>(Tool::TYPE_LINK);
  SetCommandForTool(
  ...
  // STAMP
  std::unique_ptr<Tool> stamp_tool = std::make_unique<Tool>(Tool::TYPE_STAMP);
  SetCommandForTool("touch {{output}}", stamp_tool.get());
  toolchain->SetTool(std::move(stamp_tool));

  // COPY
  std::unique_ptr<Tool> copy_tool = std::make_unique<Tool>(Tool::TYPE_COPY);
  ...
  std::unique_ptr<Tool> copy_bundle_data_tool =
      std::make_unique<Tool>(Tool::TYPE_COPY_BUNDLE_DATA);
  ...
  std::unique_ptr<Tool> compile_xcassets_tool =
      std::make_unique<Tool>(Tool::TYPE_COMPILE_XCASSETS);
