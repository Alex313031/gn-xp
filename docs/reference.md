...
```
### <a name="var_cflags"></a><a name="var_cflags_c"></a><a name="var_cflags_cc"></a><a name="var_cflags_objc"></a><a name="var_cflags_objcc"></a>**cflags***: Flags passed to the C compiler.
