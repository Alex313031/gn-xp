...
```
  ...
  no_check_targets [optional]
      ...
      running "gn check" or "gn gen --check". If neither check_targets (see
      above) or no_check_targets is specified, all targets will be checked. It
      is an error to specify both check_targets and no_check_targets.
