...
#### **\--args**: Specifies build arguments overrides.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--[no]color**: Forces colored output on or off.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--dotfile**: Override the name of the ".gn" file.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--fail-on-unused-args**: Treat unused build args as fatal errors.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--markdown**: Write help output in the Markdown format.&nbsp;[Back to Top](#gn-reference)

#### **\--ninja-executable**: Set the Ninja executable.&nbsp;[Back to Top](#gn-reference)
...
```
  ...
  gn gen out/Default --nocolor
```
#### **-q**: Quiet mode. Don't print output on success.&nbsp;[Back to Top](#gn-reference)

```
  This is useful when running as a part of another script.
```
#### **\--root**: Explicitly specify source root.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--root-target**: Override the root target.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--runtime-deps-list-file**: Save runtime dependencies for targets in file.&nbsp;[Back to Top](#gn-reference)
...
```
  ...
  "bar.so").
```
#### **\--script-executable**: Set the executable used to execute scripts.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--threads**: Specify number of worker threads.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--time**: Outputs a summary of how long everything took.&nbsp;[Back to Top](#gn-reference)
...
```
#### **\--tracelog**: Writes a Chrome-compatible trace log to the given file.&nbsp;[Back to Top](#gn-reference)
...
```
#### **-v**: Verbose logging.&nbsp;[Back to Top](#gn-reference)
