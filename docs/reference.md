...
*   [Variables you set in targets](#target_variables)
    ...
    *   [target_platform: [string] The desired platform for the build.](#var_target_platform)
...
```
  ...
  6. public_configs pulled from dependencies, in the order of the
     ...
     recursively.
```
### <a name="var_target_platform"></a>**target_platform**: The desired platform for the build.&nbsp;[Back to Top](#gn-reference)
