...
TEST(RebasePath, Strings) {
  ...
  scope->set_source_dir(SourceDir("//gn/"));

  // Build-file relative paths.
  EXPECT_EQ("../../gn", RebaseOne(scope, ".", "//out/Debug", "."));
  EXPECT_EQ("../../gn/", RebaseOne(scope, "./", "//out/Debug", "."));
  EXPECT_EQ("../../gn/foo", RebaseOne(scope, "foo", "//out/Debug", "."));
...
// Test system path output.
  ...
  EXPECT_EQ("C:/path/to/src/foo/", RebaseOne(scope, "foo/", "", "//"));
  EXPECT_EQ("C:/path/to/src/gn/foo", RebaseOne(scope, "foo", "", "."));
  ...
  EXPECT_EQ("/path/to/src/foo/", RebaseOne(scope, "foo/", "", "//"));
  EXPECT_EQ("/path/to/src/gn/foo", RebaseOne(scope, "foo", "", "."));
