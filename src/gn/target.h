...
class Target : public Item {
 public:
  ...
  // output file and is using a phony target to represent it. The exception to
  ...
  // In that scenario, both dependency_output_alias or dependency_output_file
  // will be empty.
  //
  // Callers that do not care whether the dependency is represented by a file or
  // a phony should use dependency_output().
  //
