...
Variables
  ...
  root_patterns [optional]
      ...
      toolchain context, and their transitive dependencies. When defined to
      a non empty list, only the targets in the default toolchain matching
      these patterns will be defined instead,
