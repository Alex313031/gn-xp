...
SourceFile::SourceFile(const std::string& value)
    : SourceFile(UniqueKey(Normalized(value))) {}

SourceFile::SourceFile(std::string&& value)
    : SourceFile(UniqueKey(Normalized(std::move(value)))) {}

SourceFile::SourceFile(UniqueKey value) : value_(value) {
