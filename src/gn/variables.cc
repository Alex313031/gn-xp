...
const char kMnemonic_HelpShort[] =
    "mnemonic: Prefix displayed when ninja runs this action.";
const char kMnemonic_Help[] =
    R"(mnemonic: Prefix displayed when ninja runs this action

  tools in GN can set their ninja "description" which is displayed when
  building a target. These are commonly set with the format "RUST $output"
