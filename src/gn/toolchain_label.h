...
class ToolchainLabel {
 public:
  ...
  // Convert a given string to a ToolchainLabel. This will abort if |str|
  // is not in one of the supported toolchain label formats.
  ToolchainLabel(std::string_view str);
