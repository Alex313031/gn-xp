...
TEST_F(JSONWriter, FilterTargetsWithDataDeps) {
  ...
  EXPECT_TRUE(labels_linked.count(Label(SourceDir("//foo/"), "a")) > 0);
  EXPECT_TRUE(labels_linked.count(Label(SourceDir("//foo/"), "b")) > 0);
  EXPECT_FALSE(labels_linked.count(Label(SourceDir("//foo/"), "c")) > 0);
  ...
  EXPECT_TRUE(labels_all.count(Label(SourceDir("//foo/"), "a")) > 0);
  EXPECT_TRUE(labels_all.count(Label(SourceDir("//foo/"), "b")) > 0);
  EXPECT_TRUE(labels_all.count(Label(SourceDir("//foo/"), "c")) > 0);
}
