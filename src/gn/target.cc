...
bool Target::HasRealInputs() const {
  ...
  // Actions and generated_file always have at least one input file: the
  // script used to execute the action. As such, they will never have an
  // input-less phony target. We check this first to elide the common checks.
