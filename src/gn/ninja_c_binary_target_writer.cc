...
void NinjaCBinaryTargetWriter::WriteLinkerStuff(
  ...
  UniqueVector<OutputFile> extra_rs_files;
  UniqueVector<const Target*> linkable_deps;
  UniqueVector<const Target*> non_linkable_deps;
  UniqueVector<const Target*> framework_deps;
  GetDeps(&extra_object_files, &linkable_deps, &non_linkable_deps,
          &framework_deps, &extra_rs_files);
  // At present we do not gracefully handle C++ targets which
  // depend upon Rust source sets. Only Rust targets know how
  // to intermix C++ and Rust source.
  DCHECK(extra_rs_files.empty());
