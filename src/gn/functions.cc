...
const char kScriptRunners_Help[] =
  ...
  These names are used by scripted targets, such as "action",
  "action_foreach", and "create_bundle". The name can also be passed to the
  "exec_script" function.

  See "gn help create_bundle", "gn help action_foreach",
  "gn help create_bundle", and "gn help exec_script"
