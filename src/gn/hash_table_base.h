...
class HashTableBase {
 public:
  ...
  HashTableBase(const HashTableBase& other)
      : count_(other.count_), tombstone_count_(other.tombstone_count_), size_(other.size_) {
  ...
  HashTableBase(HashTableBase&& other) noexcept
      : count_(other.count_), tombstone_count_(other.tombstone_count_), size_(other.size_), buckets_(other.buckets_) {
