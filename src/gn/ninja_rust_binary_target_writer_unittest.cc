...
TEST_F(NinjaRustBinaryTargetWriterTest, LibsOverrideFlag) {
  ...
  Toolchain toolchain_overriding_flags(
      setup.settings(), Label(SourceDir("//toolchain_overriding_flags/"), "overriding_flags"));
  toolchain_overriding_flags.GetTool("rust_binary")->set_lib_dir_switch("-Lmodified-native=");
  toolchain_overriding_flags.GetTool("rust_binary")->set_lib_switch("-lmodified-flag=");
