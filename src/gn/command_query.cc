...
bool ReadString(const IpcHandle& handle, std::string* str, std::string* error_message) {
  size_t size;
...
bool WriteString(const IpcHandle& handle, const std::string& str, std::string* error_message) {
