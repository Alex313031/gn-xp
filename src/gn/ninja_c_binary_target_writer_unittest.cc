...
TEST_F(NinjaCBinaryTargetWriterTest, RlibInLibrary) {
  ...
  SourceFile staticlib_root("//staticlib/lib.rs");
  staticlib.sources().push_back(staticlib_root);
  staticlib.source_types_used().Set(SourceFile::SOURCE_RS);
  staticlib.rust_values().set_crate_root(staticlib_root);
  staticlib.rust_values().crate_name() = "staticlib";
...
TEST_F(NinjaCBinaryTargetWriterTest, RlibsWithProcMacros) {
  ...
  Target pub_in_staticlib(setup.settings(), Label(SourceDir("//pub_in_staticlib/"), "pub_in_staticlib"));
  pub_in_staticlib.set_output_type(Target::RUST_LIBRARY);
  pub_in_staticlib.visibility().SetPublic();
  SourceFile pub_in_staticlib_root("//pub_in_staticlib/lib.rs");
  pub_in_staticlib.sources().push_back(pub_in_staticlib_root);
  ...
  Target priv_in_staticlib(setup.settings(), Label(SourceDir("//priv_in_staticlib/"), "priv_in_staticlib"));
  priv_in_staticlib.set_output_type(Target::RUST_LIBRARY);
  priv_in_staticlib.visibility().SetPublic();
  SourceFile priv_in_staticlib_root("//priv_in_staticlib/lib.rs");
  priv_in_staticlib.sources().push_back(priv_in_staticlib_root);
  ...
  pub_in_procmacro.rust_values().crate_name() = "lib2";
  ...
  SourceFile pub_in_procmacro_and_rlib_root("//pub_in_procmacro_and_rlib/lib.rs");
  ...
  pub_in_procmacro_and_rlib.rust_values().set_crate_root(pub_in_procmacro_and_rlib_root);
  ...
  procmacro.public_deps().push_back(LabelTargetPair(&pub_in_procmacro_and_rlib));
...
// Test linking of Rust dependencies into C targets.
TEST_F(NinjaCBinaryTargetWriterTest, ProcMacroInStaticLib) {
  Err err;
  TestWithScope setup;
