...
build obj/blah/liba.a: alink obj/blah/liba.a.pcm obj/blah/liba.a.o
  arflags =
  output_extension = 
  output_dir = 
)";
...
build obj/zap/b.x.o: cxx ../../zap/x.cc

build withmodules/b: link obj/zap/b.x.o obj/blah/liba.a
  ldflags =
  libs =
  frameworks =
  output_extension = 
