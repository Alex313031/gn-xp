...
TEST_F(NinjaCBinaryTargetWriterTest, NoHardDepsToNoPublicHeaderTarget) {
  ...
  const char obj_expected[] =
      ...
      "\n"
      "build obj/gen_obj.generated.o: cxx generated.cc"
      " || obj/foo/generate.stamp\n"
      "  source_file_part = generated.cc\n"
      "  source_name_part = generated\n"
      "\n"
      "build obj/foo/gen_obj.stamp: stamp obj/gen_obj.generated.o"
  ...
  EXPECT_EQ(std::string(obj_expected), obj_str) << obj_str;
  ...
  const char lib_expected[] =
      ...
      "\n"
      "\n"
      "build ./libgen_lib.so: solink obj/gen_obj.generated.o"
  ...
  EXPECT_EQ(lib_expected, lib_str) << lib_str;
