...
TEST_F(NinjaCBinaryTargetWriterTest, SwiftModule) {
...

  {
    ...
    const char expected[] =
        ...
        "\n"
        "build obj/foo/Foo.swiftmodule obj/foo/file1.o obj/foo/file2.o:"
        " swift ../../foo/file1.swift ../../foo/file2.swift\n"
        "\n"
  ...
  // Swift module_dirs correctly set if dependency between Swift modules.
  {
    ...
    const char expected[] =
        ...
        "target_output_name = bar\n"
        "\n"
        "build obj/bar/Bar.swiftmodule obj/bar/bar.o:"
        " swift ../../bar/bar.swift || obj/foo/foo.stamp\n"
        "\n"
  ...
  // C target links with module.
  {
    ...
    const char expected[] =
        ...
        "  libs =\n"
        "  frameworks =\n"
        "  modules = obj/foo/Foo.swiftmodule\n"
        "  output_extension = \n"
        "  output_dir = \n";
