...
build obj/blah/liba.a.o: cxx ../../blah/a.cc
...
build obj/stuff/libb.b.o: cxx ../../stuff/b.cc
...
build obj/stuff/libb.a: alink obj/stuff/libb.b.o
  ...
  // Then the executable that depends on it.
  {
    ...
    const char expected[] = R"(defines =
include_dirs =
module_deps = -fmodule-map-file=../../blah/a.modulemap -fmodule-file=//blah$:a=obj/blah/liba.a.pcm -fmodule-map-file=../../stuff/b.modulemap -fmodule-file=//stuff$:b=obj/stuff/libb.b.pcm
cflags =
cflags_cc =
label = //zap$:c
root_out_dir = withmodules
...
build withmodules/c: link obj/zap/c.x.o obj/zap/c.y.o obj/blah/liba.a obj/stuff/libb.a | obj/blah/liba.a.pcm obj/stuff/libb.b.pcm
  ldflags =
  libs =
  frameworks =
  swiftmodules =
