...
include_dirs =
module_deps = -fmodule-map-file=../../blah/a.modulemap -fmodule-file=//blah$:a=obj/blah/liba.a.pcm
cflags =
cflags_cc =
label = //blah$:a
...
build obj/blah/liba.a: alink obj/blah/liba.a.o
  ...
  // A second library to make sure the depender includes both.
  {
    ...
    const char expected[] = R"(defines =
include_dirs =
module_deps = -fmodule-map-file=../../stuff/b.modulemap -fmodule-file=//stuff$:b=obj/stuff/libb.b.pcm
cflags =
cflags_cc =
label = //stuff$:b
root_out_dir = withmodules
