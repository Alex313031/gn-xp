...
// Note that aligned_alloc() is not available at runtime from the
// system's C library on relatively recent OS X releases (see [1]
// for example), so use malloc() directly as a work-around to
// ensure the generated binary works everywhere.
// [1] https://github.com/Homebrew/homebrew-core/issues/46393
