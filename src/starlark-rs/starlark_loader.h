...
#ifndef TOOLS_STARLARK_STARLARK_LOADER_H_
#define TOOLS_STARLARK_STARLARK_LOADER_H_
...
// These are implemented in C++ and not Rust because while autocxx is capable of subclassing,
// the parent classes can't be derived by autocxx at time of writing.
...
#endif  // TOOLS_STARLARK_STARLARK_LOADER_H_