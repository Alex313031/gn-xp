...
include_cpp! {
    ...
    // #include "gn/value.h"
    safety!(unsafe_ffi)
    // // BuildSettings cannot successfully be generated by autocxx, so use as opaque cxx type.
    // extern_cpp_opaque_type!("BuildSettings", ffi2::BuildSettings)
    generate!("Err")
    generate!("Gen")
    generate!("InputFile")
    generate!("BlockNode")
    ...
    // generate!("Scope") // autocxx can't handle this
    // generate!("SourceFile")
    // extern_cpp_opaque_type!("Value", ffi2::Value) // won't work because both base::Value and gn::Value exist
    // extern_cpp_opaque_type!("Scope", ffi2::Scope)
    // subclass!("InputLoadResult", StarlarkLoadResult)
    // subclass!("InputAlternateLoader", StarlarkInputLoader)
}
#[cxx::bridge]
mod ffi2 {
    extern "Rust" {
    ...
    unsafe extern "C++" {
        ...
        // type BuildSettings; // autocxx can't handle this
        include!("gn/scope.h");
        type Scope; // autocxx can't handle this
        type Err = crate::ffi::Err;
        type InputFile = crate::ffi::InputFile;
        // type TokenType = crate::ffi::Token_Type;
        // type Token = crate::ffi::Token;
...
// #[subclass]
// #[derive(Default)]
// pub struct StarlarkLoadResult {
//     parse_result: &ParseResult,
// }

// impl StarlarkLoadResult {
//     pub fn new(parse_result: &ParseResult) -> Self {
//         Self { parse_result }
//     }
// }

// impl ffi::InputLoadResult_methods for StarlarkLoadResult {
//     unsafe fn Execute(&self, scope: *mut ffi::Scope, err: *mut ffi::Err) {
//         unimplemented!("lol")
//     }
// }
...
// #[subclass]
// #[derive(Default)]
// pub struct StarlarkInputLoader {
//     buildSettings: &ffi2::BuildSettings,
// }

// impl ffi::InputAlternateLoader_methods for StarlarkInputLoader {
//     fn new(build_settings: &ffi2::BuildSettings) -> Self {
//         StarlarkInputLoader::new_rust_owned(StarlarkInputLoader {
//             cpp_peer: Default::default(),
//             buildSettings: build_settings,
//         })
//     }
//     unsafe fn TryLoadAlternateFor(&self, file: &ffi::SourceFile, input_file: *mut ffi::InputFile) -> cxx::UniquePtr<ffi::InputLoadResult > {
//         unimplemented!();
//     }
// }
