...
#### **class [TargetApi](/infra/recipe_modules/target/api.py#75)([RecipeApi][recipe_engine/wkt/RecipeApi]):**

&mdash; **def [from\_string](/infra/recipe_modules/target/api.py#80)(self, platform):**

&emsp; **@property**<br>&mdash; **def [host](/infra/recipe_modules/target/api.py#83)(self):**
...
&mdash; **def [RunSteps](/infra/recipes/gn.py#34)(api, repository, platform):**
