...
void CommandLine::set_slash_is_not_a_switch() {
  ...
  DCHECK_EQ(std::u16string_view(kSwitchPrefixes[arraysize(kSwitchPrefixes) - 1]),
...
void CommandLine::ParseFromString(const string16& command_line) {
  ...
  int num_args = 0;
  char16_t** args = NULL;
  args = reinterpret_cast<char16_t**>(::CommandLineToArgvW(command_line_string.c_str(), &num_args));
