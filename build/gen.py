...
def WriteGNNinja(path, platform, host, options, args_list):
  ...
  if options.experimental_stargn:
    cgo_executables = {
        'stargn': {'sources': [
            'src/starlark-go/stargn_main.cc',
            'src/starlark-go/stargn_main.go',
            'src/starlark-go/stargn_main.h',
            'src/starlark-go/starlark_glue.cc',
            'src/starlark-go/starlark_glue.go',
            'src/starlark-go/starlark_glue.h',
        ], 'module_dir': 'src/starlark-go', 'libs': static_libraries.keys()},
    }
  else:
    cgo_executables = {}
