...
def WriteGNNinja(path, platform, host, options):
  ...
  static_libraries = {
      ...
      'gn_lib': {'sources': [
        ...
        'tools/gn/ninja_write_data_target_writer.cc',
        ...
        'tools/gn/write_data_target_generator.cc',
  ...
  executables = {
      ...
      'gn_unittests': { 'sources': [
        ...
        'tools/gn/function_get_metadata_unittest.cc',
        ...
        'tools/gn/ninja_write_data_target_writer_unittest.cc',
